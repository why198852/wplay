...
import com.wplay.spark.redis.rdd.RedisKeysRDD
import com.wplay.spark.redis.streaming.RedisInputDStream
...
class RedisContext(@transient val sc: SparkContext) extends Serializable {
  ...
  import com.wplay.spark.redis.RedisContext._
